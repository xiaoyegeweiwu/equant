...
_all_func_ = {
    ...
    #                 ['CurrentEntries'      , '当前持仓的建仓次数'],
                    ...
                    ['LastBuyEntryPrice'   , '当前Buy持仓的最后一个建仓价格'],
                    ['LastSellEntryPrice'  , '当前Sell持仓的最后一个建仓价格'],
                    ['HighestSinceLastBuyEntry' , '当前Buy持仓的最后一个建仓以来的最高价'],
                    ['LowestSinceLastBuyEntry' ,  '当前Buy持仓的最后一个建仓以来的最低价'],
                    ['HighestSinceLastSellEntry' , '当前Sell持仓的最后一个建仓以来的最高价'],
                    ['LowestSinceLastSellEntry' ,  '当前Sell持仓的最后一个建仓以来的最低价'],
