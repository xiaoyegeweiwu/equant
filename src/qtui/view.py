...
class StrategyPolicy(QWidget):
    ...
    def create_money_policy(self):
        ...
        self.openTypeComboBox.setFixedWidth(65)
        self.openFeeRateLineEdit.setFixedWidth(65)
        self.closeTypeComboBox.setFixedWidth(65)
        self.closeFeeRateLineEdit.setFixedWidth(65)
        self.slippageLineEdit.setFixedWidth(65)
